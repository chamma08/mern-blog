                ...
                {imageFileUploadProgress && (
                    <CircularProgressbar value={imageFileUploadProgress || 0} text={`${imageFileUploadProgress}%`} 
                        ...
                        styles={{
                            ...
                            path: { stroke: `rgba(62, 231, 218, ${imageFileUploadProgress / 100})`},
                        }}
                    />
                )}  
                <img src={imageFileUrl || currentUser.profilePicture} alt="" className={`rounded-full w-full h-full object-cover border-8 border-[lightgray] ${imageFileUploadProgress && imageFileUploadProgress < 100 && 'opacity-60'}`}/>
            </div>
        ...
        <Modal show={showModal} onClose={() => setShowModal(false)} popup size={'md'}>
            ...
            <Modal.Body>
                <div className="text-center">
                    <HiOutlineExclamationCircle className='text-gray-500 dark:text-gray-200 mb-4 mx-auto text-5xl h-14 w-14'/>
                    <h3 className='text-lg mb-5 text-gray-500 dark:text-gray-200 font-bold'>Are you sure you want to delete your account?</h3>
